...
def events_calendar_page():
    ...
    for _, ev in df_filtrado.iterrows():
        ...
        # Encontrar todas as ocorrências do dia no calendário e substituir a tag <td>
        # Note que isso pode sobrescrever múltiplos dias iguais
        # Uma abordagem mais robusta pode ser necessária para calendários mais complexos
...
def analytics_page():
    ...
    # Importações necessárias para MitoSheet
